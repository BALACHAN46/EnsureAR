...
(function ($) {
	...
	window.initTheme = function() {
        ...
        $('.mr_menu_toggle').on('click', function(e) {
            const isActive = $('body').hasClass('mr_menu_active');
            if (isActive) {
        ...
        $(window).resize(function(){
            ...
            $(' .ens-slider.style2 .swiper-container, .ens-slider.style3 .swiper-container,.ens-slider.style5 .swiper-container').height(height);
            $('.ens-slider.style2 .swiper-slide, .ens-slider.style3 .swiper-slide, .ens-slider.style5 .swiper-slide').height(height);
            // $('.ens-slider .swiper-container, .ens-slider .swiper-slide').width(width);
        ...
        // Main Slider One
        var SwiperSliderOne = new Swiper('.ens-swiper-slider-one', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Two
        var SwiperSliderTwo = new Swiper('.ens-swiper-slider-two', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Three
        var SwiperSliderThree = new Swiper('.ens-swiper-slider-three', {
            loop: true,
            // autoplay: {
            //     delay: 3000,
            // },
        ...
        // Slider Four
        var SwiperSliderFour = new Swiper('.ens-swiper-slider-four', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Five
        var SwiperSliderFive = new Swiper('.ens-swiper-slider-five', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Six
        var SwiperSliderSix = new Swiper('.ens-swiper-slider-six', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Seven
        var SwiperSliderSevenThumbs = new Swiper('.ens-swiper-slider-seven-thumbs', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        var SwiperSliderSeven = new Swiper('.ens-swiper-slider-seven', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // $('.ens-swiper-slider-seven-thumbs .swiper-slide:not(".swiper-slide-active") .ens-slider--item .ens-item--title span').on('mouseover', function() {
        ...
        // Slider Eight
        var SwiperSliderEight = new Swiper('.ens-swiper-slider-eight', {
            loop: true,
            // autoplay: {
            //     delay: 3000,
            // },
        ...
        // Slider Nine
        var SwiperSliderNine = new Swiper('.ens-swiper-slider-nine', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Ten
        var SwiperSliderTenThumbs = new Swiper('.ens-swiper-slider-ten-thumbs', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Ten
        var SwiperSliderTen = new Swiper('.ens-swiper-slider-ten', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Tweleve
        var SwiperSlidertwelve = new Swiper('.ens-swiper-slider-twelve', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Thirteen
        var SwiperSliderThirteen = new Swiper('.ens-swiper-slider-thirteen', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Fourteen
        var SwiperSliderFourteen = new Swiper('.ens-swiper-slider-fourteen', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Fifteen
        var SwiperSliderFifteen = new Swiper('.ens-swiper-slider-fifteen', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Sixteen
        var SwiperSliderSix = new Swiper('.ens-swiper-slider-sixteen', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Seventeen
        var SwiperSliderSeventeen = new Swiper('.ens-swiper-slider-seventeen', {
            loop: false,
            autoplay: {
                delay: 3000,
            },
        ...
        // Slider Fourteen
        var SwiperSliderTwentyOne = new Swiper('.ens-swiper-slider-twentyone', {
            loop: true,
            autoplay: {
                delay: 3000,
            },
        ...
        /* GET ALL VIDEOS */
        var sliderVideos = $(".ens-swiper-slider-twentyone video");
        ...
        $('.ens-image-box1, .ens-image-box2, .ens-blog-grid1, .ens-packages1, .ens-icon-box2, .ens-icon-box5, .ens-icon-box7, .ens-award-list .ens-item, .ens-features .ens-item').on("mouseenter", function(){     
            $('.ens-image-box1, .ens-image-box2, .ens-blog-grid1, .ens-packages1, .ens-icon-box2, .ens-icon-box5, .ens-icon-box7, .ens-award-list .ens-item, .ens-features .ens-item').removeClass('active');    
        }).on('mouseleave',  function(){ 
            $('.ens-image-box1.highlight, .ens-image-box2.highlight, .ens-blog-grid1.highlight, .ens-packages1.highlight, .ens-icon-box2.highlight, .ens-icon-box5.highlight, .ens-icon-box7.highlight, .ens-award-list .ens-item.highlight, .ens-features .ens-item.highlight').addClass('active');     
        });

        // accordion
        $(".ens-accordion").on("click",".ens-item-title", function () {
            $(this).next().slideDown();
            $(".ens-item--content").not($(this).next()).slideUp();
        });

        $(".ens-accordion").on("click",".ens--item", function () {
        ...
        // Vertical Accordion
          $('.ens-country-tab--title').on('click', function () {
            $('.ens-country-tab--item').removeClass('active');
            $(this).parent('.ens-country-tab--item').addClass('active');
        });
        ...
        // Header Cart open
		$('a.ens-cart-icon').on('click', function (e) {
			e.preventDefault();
			$('.ens-cart-box').toggleClass('active');
		});
